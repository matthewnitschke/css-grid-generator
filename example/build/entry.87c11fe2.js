...
},{"_css_loader":"../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../src/CSSGridGenerator.jsx":[function(require,module,exports) {
"use strict";
...
var CSSGridGenerator =
/*#__PURE__*/
function (_Component) {
  _inherits(CSSGridGenerator, _Component);

  function CSSGridGenerator(props) {
    var _this;

    _classCallCheck(this, CSSGridGenerator);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(CSSGridGenerator).call(this, props));
  ...
  _createClass(CSSGridGenerator, [{
    key: "render",
    value: function render() {
      var rowCount = this.state.rows.split(' ').length;
      var columnCount = this.state.columns.split(' ').length;
      var layoutChildrenCount = rowCount * columnCount;
      var gridTemplateAreaMatrix = this.state.templateAreas.split('\n').map(function (e) {
        return e.split(' ');
      });
      var r = 0;
      var c = 0;
      var layoutChildrenDom = Array(layoutChildrenCount).fill().map(function (e, i) {
        if (i != 0) {
          if (i % columnCount == 0) {
            c = 0;
            r++;
        ...
        if (gridTemplateAreaMatrix.length > r && gridTemplateAreaMatrix[r].length > c && gridTemplateAreaMatrix[r][c] && gridTemplateAreaMatrix[r][c] != ".") {
          text = gridTemplateAreaMatrix[r][c];
        }

        return _react.default.createElement("div", {
          key: i,
          className: "layout-view-child",
          title: text
        }, text);
      });
      var templateAreasInvalid = false;
      gridTemplateAreaMatrix.forEach(function (c, i) {
      ...
      return _react.default.createElement("div", {
        className: "css-grid-generator"
      }, _react.default.createElement("div", {
        className: "tac"
      }, _react.default.createElement("pre", {
        className: "code-view dib tal"
      ...
      }, _react.default.createElement("div", null, "grid-template-columns", _react.default.createElement("span", {
        style: {
          color: "#ff79c6"
        }
      }, ":"), " ", _react.default.createElement("input", {
        className: "code-view-input",
        autoComplete: "off",
      ...
      }, ";")), _react.default.createElement("div", null, "grid-template-rows", _react.default.createElement("span", {
        style: {
          color: "#ff79c6"
        }
      }, ":"), " ", _react.default.createElement("input", {
      ...
      }, ";")), _react.default.createElement("div", null, "grid-column-gap", _react.default.createElement("span", {
        style: {
          color: "#ff79c6"
        }
      }, ":"), " ", _react.default.createElement("input", {
        className: "code-view-input small",
        autoComplete: "off",
      ...
      }, ";")), _react.default.createElement("div", null, "grid-row-gap", _react.default.createElement("span", {
        style: {
          color: "#ff79c6"
        }
      }, ":"), " ", _react.default.createElement("input", {
      ...
      }, ";")), _react.default.createElement("div", null, _react.default.createElement("div", null, "grid-template-areas", _react.default.createElement("span", {
        style: {
          color: "#ff79c6"
        }
      }, ":"), _react.default.createElement("div", {
        ...
        rows: rowCount,
        className: "code-view-input ".concat(templateAreasInvalid ? 'invalid' : ''),
        autoComplete: "off",
...
exports.default = CSSGridGenerator;
},{"react":"../node_modules/react/index.js","./styles.scss":"../src/styles.scss"}],"entry.js":[function(require,module,exports) {
"use strict";
...
var _CSSGridGenerator = _interopRequireDefault(require("../src/CSSGridGenerator.jsx"));
...
}, _react.default.createElement(_CSSGridGenerator.default, null)), document.getElementById('root'));
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","../src/CSSGridGenerator.jsx":"../src/CSSGridGenerator.jsx"}],"../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
